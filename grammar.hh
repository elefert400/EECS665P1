...
#line 64 "grammar.hh" // lalr1.cc:377
...
namespace lake {
#line 136 "grammar.hh" // lalr1.cc:377
...
lake::StructDeclNode * structDeclNode;
lake::FormalsListNode * formals;
...
#line 181 "grammar.hh" // lalr1.cc:377
    };
#else
    ...
    Parser (lake::Scanner  &scanner_yyarg, lake::Compiler &compiler_yyarg);
    virtual ~Parser ();
  ...
  private:
    ...
    // User arguments.
    lake::Scanner  &scanner;
    lake::Compiler &compiler;
  };


#line 5 "lake.yy" // lalr1.cc:377
} // lake
#line 556 "grammar.hh" // lalr1.cc:377
